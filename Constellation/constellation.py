...
plt.subplot(1,1,1)
plt.scatter(x,y)
plt.title('Orion Constellation 2D plot')
plt.show()
...
FL_Virginis = [-13.7, -1.86, 2.27]
Luytens_Star = [-4.592, 11.45, 1.128 ]
x.extend([Sirius[0],FL_Virginis[0],Luytens_Star[0]])
y.extend([Sirius[1],FL_Virginis[1],Luytens_Star[1]])
z.extend([Sirius[2],FL_Virginis[2],Luytens_Star[2]])
